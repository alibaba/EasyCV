...
data_root = 'small_cityscapes_raw/'

train_img_root = data_root + 'imgs/train/'
train_label_root = data_root + 'labels/train/'

val_img_root = data_root + 'imgs/val/'
val_label_root = data_root + 'labels/val/'
data = dict(
    imgs_per_gpu=6,
    workers_per_gpu=4,
