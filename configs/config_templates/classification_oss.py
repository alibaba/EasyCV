...
data = dict(
    ...
    train=dict(
        type='ClsDataset',
        data_source=dict(
            list_file='oss://path/to/data/imagenet-raw/meta/train_labeled.txt',
    ...
    val=dict(
        type='ClsDataset',
        data_source=dict(
            list_file='oss://path/to/data/imagenet-raw/meta/val_labeled.txt',
            root='oss://path/to/data/imagenet-raw/validation/',
            type='ClsSourceImageList'),
        pipeline=[
