...
if __name__ == '__main__':
    ...
    predictor = OCRPredictor(
        det_model_path='../../out/det_ocr_ch/epoch_10_export.pth',
        rec_model_path=
        '/root/code/ocr/PaddleOCR/pretrain_models/ch_PP-OCRv3_rec_train/best_accuracy_student_export.pth',
        cls_model_path=
        '/root/code/ocr/PaddleOCR/pretrain_models/ch_ppocr_mobile_v2.0_cls_train/best_accuracy_export.pth',
        use_angle_cls=True)
    ...
    for img_path in img_list:
        ...
        out_img = predictor.show(
            ...
            img,
            font_path=
            '/nas/code/ocr/PaddleOCR2Pytorch-main/doc/fonts/simfang.ttf')
