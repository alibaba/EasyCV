...
class FCOSOutputs(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.focal_loss_alpha = cfg.loss_alpha
        self.focal_loss_gamma = cfg.loss_gamma
        self.center_sample = cfg.center_sample
        self.radius = cfg.radius
        self.pre_nms_thresh_train = cfg.pre_nms_thresh_train
        self.pre_nms_topk_train = cfg.pre_nms_topk_train
        self.post_nms_topk_train = cfg.post_nms_topk_train
        self.loc_loss_func = IOULoss(cfg.loc_loss_type)

        self.pre_nms_thresh_test = cfg.pre_nms_thresh_test
        self.pre_nms_topk_test = cfg.pre_nms_topk_test
        self.post_nms_topk_test = cfg.post_nms_topk_test
        self.nms_thresh = cfg.nms_thresh
        self.thresh_with_ctr = cfg.thresh_with_ctr
        self.box_quality = cfg.box_quality
        ...
        soi = []
        prev_size = -1
        for s in cfg.sizes_of_interest:
            soi.append([prev_size, s])
            prev_size = s
        soi.append([prev_size, INF])
        self.sizes_of_interest = soi

        self.loss_normalizer_cls = cfg.loss_normalizer_cls
        ...
        self.loss_weight_cls = cfg.loss_weight_cls
    ...
    def compute_targets_for_locations(self, locations, targets, size_ranges,
        ...
        for im_i in range(len(targets)):
            ...
            bboxes = targets_per_im['gt_bboxes']
    ...
    def fcos_losses(self, instances):
        ...
        num_pos_avg = max(reduce_mean(num_pos_local.float()).item(), 1.0)
